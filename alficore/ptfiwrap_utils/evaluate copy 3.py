...
def get_Ranger_bounds2(model, ranger_file_name, dataset_name='coco2017', batch_size=1, sampleN=0.2, get_perc=False):
    ...
    if dataset_name=='lyft':
        ...
        print('Loading lyft...')
        dataloader = Lyft_dataloader(dataset_type='val', batch_size=batch_size, sampleN=sampleN, shuffle=False, num_workers=4)
