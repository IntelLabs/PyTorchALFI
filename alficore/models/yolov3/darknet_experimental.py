...
from .utils import count_parameters as count
from .utils import convert2cpu as cpu
from .utils import predict_transform, parse_model_config
    ...
    for module_i, module_def in enumerate(module_defs):
        ...
        if module_def["type"] == "convolutional":
            ...
            if module_def["activation"] == "leaky":
                ...
                modules.add_module(f"relu_{module_i}", nn.LeakyReLU(0.))
...
class Darknet_Experimental(nn.Module):
    """YOLOv3 object detection model"""

    def __init__(self, config_path):
        super(Darknet_Experimental, self).__init__()
