...
def main(argv):
    ...
    hw_spec = ["neurons", [1,3]] #weights, neurons; bit_pos
    noise_magn = 10
    ...
    if "hw" in flt_type:
        extra = "Memory_fault: " + hw_spec[0] + ", bit " + str(int(fault_file[6]))
    else:
    ...
    plt.savefig(save_name, bbox_inches = 'tight',  pad_inches = 0.1, dpi=200, format='png')
    ...
    plt.savefig(sv_path, dpi=200, bbox_inches='tight')
    print('saved', sv_path)
