from resiliency_methods.Ranger import Ranger, Ranger_trivial, Ranger_BackFlip, Ranger_Clip, Ranger_FmapAvg, Ranger_FmapRescale
import torch
import numpy as np
from util.ranger_automation import My_Bottleneck_Ranger, My_Reshape
...
def set_ranger_hooks_v3(net, bnds, mitigation=False):
    """
