...
def main(argv):
    ...
    model_name = 'retina' #'yolov3', 'retina', 'ssd'

    batch_size = 5 #batchsize for neurons
    num_faults = 1 #faults
    num_runs = 1 #number of runs #500
    sample_size = 0.2 #nr of images (sequential)
    ...
    # Storing location ---------------------------------------------------------
    yml_file = 'default_min_quant_test_auto_bnds.yml'
