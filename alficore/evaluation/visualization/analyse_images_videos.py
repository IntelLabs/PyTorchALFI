...
# ######################################################################
folder = '/home/fgeissle/ranger_repo/ranger/result_files/yolov3_ultra_50_trials/weights_injs/per_batch/objDet_20220513-133033_1_faults_[0_32]_bits/coco2017/val'
dataset = 'coco2017'
batch_size = 1
img_ids = None
epochs = [0] #list(range(0))
# ######################################################################


gt_json_file = folder + '/coco_format.json'
dt_json_file = folder + '/orig_model/epochs/0/coco_instances_results_0_epoch.json'
