...
"""
This file contains functions to parse COCO-format annotations into dicts in "pytorchALFI format".
"""
...
class Kitti_obj_det_native_dataloader(Abstract_Loader):
    ...
    def load_json(self, json_file, image_root, dl_attr:TEM_Dataloader_attr, dataset_name=None, extra_annotation_keys=None):
        ...
        Returns:
            list[dict]: a list of dicts in standard dataset dicts format.
        ...
        ann_keys = ["iscrowd", "bbox", "truncated", "visible", "category_id"] + (extra_annotation_keys or [])
