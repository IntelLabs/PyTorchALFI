...
import image_classification.MMAL.resnet as resnet
from image_classification.MMAL.config import pretrain_path, coordinates_cat, iou_threshs, window_nums_sum, ratios, N_list
import numpy as np
from image_classification.MMAL.AOLM import AOLM
...
class MainNet(nn.Module):
    ...
    def forward(self, x, status='test', DEVICE='cuda'):
        ...
        if coordinates.nelement() == 0:
            return None, None, None, None, None, None, torch.zeros((1,100)), None
