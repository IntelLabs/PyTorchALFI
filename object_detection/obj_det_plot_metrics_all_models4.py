...
for flt_type in flts:
    ...
    model_dict = {"model_name": 'yolov3', "dataset_name": 'coco2017', "flt_type": flt_type, "suffix": suffix, 'bits': 32, "label_name": "Yolo+Coco"}
    toplot_dict, ax_leg = add_data(toplot_dict, ax_leg, model_dict)

    model_dict = {"model_name": 'yolov3', "dataset_name": 'kitti', "flt_type": flt_type, "suffix": suffix, 'bits': 32, "label_name": "Yolo+kitti"}
    toplot_dict, ax_leg = add_data(toplot_dict, ax_leg, model_dict)

    model_dict = {"model_name": 'yolov3u_silu', "dataset_name": 'lyft', "flt_type": flt_type, "suffix": suffix, 'bits': 32, "label_name": "Yolo+Lyft"}
    toplot_dict, ax_leg = add_data(toplot_dict, ax_leg, model_dict)

    model_dict = {"model_name": 'retina005', "dataset_name": 'coco2017', "flt_type": flt_type, "suffix": suffix, 'bits': 32, "label_name": "RetinaNet+Coco"}
    toplot_dict, ax_leg = add_data(toplot_dict, ax_leg, model_dict)

    model_dict = {"model_name": 'detectron', "dataset_name": 'coco2017', "flt_type": flt_type, "suffix": suffix, 'bits': 32, "label_name": "FRCNN+Coco"}
    toplot_dict, ax_leg = add_data(toplot_dict, ax_leg, model_dict)

    model_dict = {"model_name": 'detectron', "dataset_name": 'kitti', "flt_type": flt_type, "suffix": suffix, 'bits': 32, "label_name": "FRCNN+Kitti"}
    toplot_dict, ax_leg = add_data(toplot_dict, ax_leg, model_dict)
